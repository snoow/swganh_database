...
CREATE TABLE `galaxy` (
  ...
  `galaxy_name` varchar(128) NOT NULL DEFAULT '',
  `galaxy_version` varchar(16) NOT NULL DEFAULT '',
  `galaxy_status` int(10) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `galaxy` VALUES (1,'A New Hope','',2,'2011-10-14 17:14:13','2011-10-14 17:14:13');
