...
--
-- Table structure for table `ticket_collectors`
--
...
CREATE TABLE `ticket_collectors` (
  ...
  PRIMARY KEY (`id`),
  KEY `ticket_collector_planet_id` (`planet_id`),
  CONSTRAINT `ticket_collector_planet_id` FOREIGN KEY (`planet_id`) REFERENCES `planet` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ticket_collectors` VALUES (4563402753,1692104,'object/tangible/travel/ticket_collector/shared_ticket_collector.iff',0,0.998785,0,0.0492769,-0.1,8,-12.1,5,'ticket_collector_name','travel','Theed Spaceport'),
