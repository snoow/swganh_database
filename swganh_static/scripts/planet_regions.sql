...
--
-- Table structure for table `planet_regions`
--
...
CREATE TABLE `planet_regions` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Planet Region ID',
  `region_name` varchar(255) DEFAULT 'region_name' COMMENT 'Planet Region Name',
  `region_file` varchar(255) DEFAULT 'region_file' COMMENT 'Planet Region FileName',
  `x` float NOT NULL DEFAULT '0',
  `z` float NOT NULL DEFAULT '0',
  `width` float NOT NULL DEFAULT '0',
  `length` float NOT NULL DEFAULT '0',
  `planet_id` int(10) unsigned DEFAULT NULL COMMENT 'Planet',
...
LOCK TABLES `planet_regions` WRITE;
/*!40000 ALTER TABLE `planet_regions` DISABLE KEYS */;
INSERT INTO `planet_regions` VALUES (1,'dantooine_mining_outpost','dantooine_region_names',-618,2470,0,600,1,1,1),
