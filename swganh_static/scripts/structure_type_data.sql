...
--
-- Table structure for table `structure_type_data`
--
...
LOCK TABLES `structure_type_data` WRITE;
/*!40000 ALTER TABLE `structure_type_data` DISABLE KEYS */;
INSERT INTO `structure_type_data` VALUES (1,'object/building/poi/shared_scout_camp_s0.iff',0,'Basic Camp','basic_name','camp',0.65,0,0,0,0,0,0,0,0,0,464,0,0,0,0,0,4398046512127,0),
