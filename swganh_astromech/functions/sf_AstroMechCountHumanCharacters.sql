...
--
-- `sf_AstroMechCountHumanCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountHumanCharacters`;
CREATE FUNCTION `sf_AstroMechCountHumanCharacters`() RETURNS int(5)
BEGIN
