...
--
-- `sf_AstroMechCountRodianCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountRodianCharacters`;
CREATE FUNCTION `sf_AstroMechCountRodianCharacters`() RETURNS int(5)
BEGIN
  ...
  WHERE (swganh.characters.firstname NOT LIKE '%bot%') AND (swganh.race.name like '%rodian%') INTO result;
