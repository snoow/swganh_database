...
--
-- `sf_AstroMechCountIthorianCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountIthorianCharacters`;
CREATE FUNCTION `sf_AstroMechCountIthorianCharacters`() RETURNS int(5)
BEGIN
  ...
  WHERE (swganh.characters.firstname NOT LIKE '%bot%') AND (swganh.race.name like '%ithorian%') INTO result;
