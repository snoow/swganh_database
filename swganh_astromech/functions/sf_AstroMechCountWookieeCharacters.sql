...
--
-- `sf_AstroMechCountWookieeCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountWookieeCharacters`;
CREATE FUNCTION `sf_AstroMechCountWookieeCharacters`() RETURNS int(5)
BEGIN
