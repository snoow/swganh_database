...
--
-- `sf_AstroMechCountMonCalamariCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountMonCalamariCharacters`;
CREATE FUNCTION `sf_AstroMechCountMonCalamariCharacters`() RETURNS int(5)
BEGIN
  ...
  WHERE (swganh.characters.firstname NOT LIKE '%bot%') AND (swganh.race.name like '%moncal%') INTO result;
