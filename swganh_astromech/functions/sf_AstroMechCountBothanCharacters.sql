...
--
-- `sf_AstroMechCountBothanCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountBothanCharacters`;
CREATE FUNCTION `sf_AstroMechCountBothanCharacters`() RETURNS int(5)
BEGIN
  ...
  WHERE (swganh.characters.firstname NOT LIKE '%bot%') AND (swganh.race.name like '%bothan%') INTO result;
