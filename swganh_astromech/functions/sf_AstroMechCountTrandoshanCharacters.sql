...
--
-- `sf_AstroMechCountTrandoshanCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountTrandoshanCharacters`;
CREATE FUNCTION `sf_AstroMechCountTrandoshanCharacters`() RETURNS int(5)
BEGIN
  ...
  WHERE (swganh.characters.firstname NOT LIKE '%bot%') AND (swganh.race.name like '%trandoshan%') INTO result;
