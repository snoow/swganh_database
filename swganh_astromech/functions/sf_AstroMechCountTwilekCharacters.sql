...
--
-- `sf_AstroMechCountTwilekCharacters`
--

DROP FUNCTION IF EXISTS `sf_AstroMechCountTwilekCharacters`;
CREATE FUNCTION `sf_AstroMechCountTwilekCharacters`() RETURNS int(5)
BEGIN
  ...
  WHERE (swganh.characters.firstname NOT LIKE '%bot%') AND (swganh.race.name like '%twilek%') INTO result;
